            ...
            collections.length > 0 ? (
              <ol>
                ...
                <li
                  ...
                  onClick={() =>
                    this.setState({
                      collection: { name: t`Todo lo demás` },
                      query: { collection: "" },
                    })
                  }
                >
  ...
  render() {
    ...
    return (
      <div className="wrapper wrapper--trim">
        <ModalContent
          title={t`Elige una pregunta para agregar`}
            ...
            <div className="flex align-center ml3 mb3">
              ...
              {query && (
                <div className="ml-auto flex align-center pr2">
                  <h5>Sort by</h5>
                  <Button borderless>{t`Última modificación`}</Button>
                  <Button borderless>{t`Orden alfabético`}</Button>
                </div>
              )}
            </div>
          </div>
